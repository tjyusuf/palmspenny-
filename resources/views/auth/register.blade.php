<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo">
            ...
            <h2 class="mt-0 text-3xl font-extrabold text-center text-gray-500 leading-9">
                Create a new account
            </h2>
            <p class="mt-1 text-sm text-center text-gray-600 leading-5 max-w">
                Or
                <a href="/login" class="font-medium text-primary hover:text-primary-dark focus:outline-none focus:underline transition ease-in-out duration-150">
